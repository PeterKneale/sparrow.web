...
const Contractors = () => {
    return (
        <div>
            <Button bsStyle="primary" bsSize="large" className="pull-right">Create Contractor</Button>
            <Header heading="Contractors" subheading="Your contractors."/>
            <div className="panel panel-default">

                <div className="panel-heading">Current Contractors</div>
